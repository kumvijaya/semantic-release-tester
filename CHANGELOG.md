## [11.1.1](https://github.com/kumvijaya/semantic-release-tester/compare/v11.1.0...v11.1.1) (2023-04-23)


### 🐛 Bug-Fix

* bugfix with basic functions ([7d56a49](https://github.com/kumvijaya/semantic-release-tester/commit/7d56a492741905e8945c97085d208363891a56aa))

## [11.1.0](https://github.com/kumvijaya/semantic-release-tester/compare/v11.0.0...v11.1.0) (2023-04-23)

## [11.0.0](https://github.com/kumvijaya/semantic-release-tester/compare/v10.0.0...v11.0.0) (2023-04-23)


### ✨ Major

* First release with basic functions ([04cfbf3](https://github.com/kumvijaya/semantic-release-tester/commit/04cfbf3ac7ca9f79e5defd9106c3eeb9dc0857ee))
* First release with basic functions ([f42abbc](https://github.com/kumvijaya/semantic-release-tester/commit/f42abbc1d451566e627acf19c99ecdc844f1d707))

## [10.0.0](https://github.com/kumvijaya/semantic-release-tester/compare/v9.0.0...v10.0.0) (2023-04-23)


### ⚠ BREAKING CHANGES

* update for notes test

* fix(ci): update in workflow yml for extra plugins
...
* fix(ci): update in workflow yml for commit check
...
* [major] : update in preset type for commit check

* chore(release): 3.0.0 [skip ci]

## [3.0.0](https://github.com/kumvijaya/semantic-release-tester/compare/v2.2.2...v3.0.0) (2023-04-22)

* [major] : update in preset config for commit check

* chore(release): 4.0.0 [skip ci]

## [4.0.0](https://github.com/kumvijaya/semantic-release-tester/compare/v3.0.0...v4.0.0) (2023-04-22)

* [bug-fix] : update in preset types for commit check

* [bug-fix] : update in preset types for commit check

* bug-fix : update in preset types for commit check

* improvement : update in preset types for commit check

* improvement(ci): update in preset types for commit check
...
* bug-fix(input check): update in preset types for commit check

* bug-fix(input check): update in preset types for commit check

* bug-fix(ci): update in preset types for commit check

* bugfix(ci): update in preset types for commit check
...
* [bugfix]: update in preset types for commit check
...
* Fix: update in preset types for commit check
...
* plain no key update in preset types for commit check
...
* major: update in preset types for commit check
...
* [major](big): update in preset types for commit check

* [major](ci): update in preset types for commit check
...
* issue: update in preset types for commit check
...
* [minor]: update in preset types for commit check

* [minor]: update in preset types for commit check

* update in preset types for commit check

* Master (#2) ([aff8ed4](https://github.com/kumvijaya/semantic-release-tester/commit/aff8ed463df02238bffb0d1dd97d93f358c6ec08)), closes [#2](https://github.com/kumvijaya/semantic-release-tester/issues/2)


### ✨ Major

* First release with basti functions ([e08f301](https://github.com/kumvijaya/semantic-release-tester/commit/e08f301937bff2dbdecbbcf468a7168d2a0500bb))
